...
require 'activeadmin_ckeditor_with_uploads/models/upload'
require 'activeadmin_ckeditor_with_uploads/models/uploaded_file'
require 'activeadmin_ckeditor_with_uploads/models/uploaded_image'
